...
public class SplashScreen extends Screen {
    ...
    public SplashScreen(ActionHandler handler) {
        ...
        super.append(TextTools.addPadding(introduction, TextTools.TERMINAL_WIDTH, TextTools.TERMINAL_PADDING));
        super.append(TextTools.emptyLines(2));

        //begin journey
        super.append(new String[]{TextTools.centerInRow("≈≈≈ So lasset die Reise beginnen ≈≈≈", TextTools.TERMINAL_WIDTH)});
        super.append(TextTools.emptyLines(2));
