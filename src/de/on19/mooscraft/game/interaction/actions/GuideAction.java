...
public class GuideAction implements DescriptedAction {
    ...
    public void onCommand(String[] args, ActionHandler handler) {
        ...
        screen.append(new String[]{
                TextTools.centerInRow("≈≈≈ Spielanleitung≈≈≈", TextTools.TERMINAL_WIDTH),
        });
        ...
        screen.append(TextTools.addPadding(instructions, TextTools.TERMINAL_WIDTH, TextTools.TERMINAL_PADDING));
