...
public class Spot2 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        Screen s = new Screen();
        s.appendLine(TextTools.centerInRow("≈≈≈ Ein Zelt ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        s.appendLine(TextTools.wrapToLength("Du hast nun wieder \u001b[1;91m10 Einheiten mehr Willenskraft\u001b[0m.", TextTools.TERMINAL_WIDTH));
