...
public class Spot6 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        Screen s = new Screen();
        s.appendLine(TextTools.centerInRow("≈≈≈ Der Wald lichtet sich ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        if (character.getWitchcraft() >= 20) {
            s.append(TextTools.addPadding(woncliff, TextTools.TERMINAL_WIDTH, TextTools.TERMINAL_PADDING));
        } else {
            s.append(TextTools.addPadding(lostcliff, TextTools.TERMINAL_WIDTH, TextTools.TERMINAL_PADDING));
