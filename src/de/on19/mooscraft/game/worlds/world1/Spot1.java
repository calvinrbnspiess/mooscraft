...
public class Spot1 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        ...
        s.appendLine(TextTools.centerInRow("≈≈≈ Tief im Odenwald ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        s.appendLine(TextTools.wrapToLength("Du nimmst den Kampf auf und verlierst \u001b[1;95m5 Einheiten an Lebensenergie.\u001b[0m", TextTools.TERMINAL_WIDTH));
        s.append(TextTools.emptyLines(2));
