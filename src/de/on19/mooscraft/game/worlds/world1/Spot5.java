...
public class Spot5 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        ...
        s.appendLine(TextTools.centerInRow("≈≈≈ Im Nebel ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        s.appendLine(TextTools.wrapToLength("Du gehst immer weiter darauf zu.", TextTools.TERMINAL_WIDTH));
        s.append(TextTools.emptyLines(2));
