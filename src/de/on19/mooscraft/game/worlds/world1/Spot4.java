...
public class Spot4 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        ...
        s.appendLine(TextTools.centerInRow("≈≈≈ Plötzlich auf dem Weg ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        s.appendLine(TextTools.wrapToLength("Du verlierst \u001b[1;95m5 Einheiten an Lebensenergie\u001b[0m, erschöpft gehst du weiter.", TextTools.TERMINAL_WIDTH));
        s.append(TextTools.emptyLines(2));
