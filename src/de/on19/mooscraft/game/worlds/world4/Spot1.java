...
public class Spot1 extends Spot {
    ...
    public void onEnter(Game game, Character character) {
        Screen s = new Screen();
        s.appendLine(TextTools.centerInRow("≈≈≈ Eine Waffe ≈≈≈", TextTools.TERMINAL_WIDTH));
        ...
        s.appendLine(TextTools.wrapToLength("Du bekommst \u001b[1;96m10 Einheiten an Stärke.\u001b[0m", TextTools.TERMINAL_WIDTH));
